...
export default function AdminHeader({ stats, onNewProduct }: AdminHeaderProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Gestiona productos, pedidos y configuración de la tienda</p>
        </div>
